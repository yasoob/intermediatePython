...
copyright = '<a href="https://yasoob.me"> Yasoob Khalid </a> &copy; 2020'
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'sphinx', 'projects']
...
latex_additional_files = ['_static/cover.pdf']
numfig = True
